    ...
    return (
        <footer className="py-20 px-4 border-t border-white/20 flex flex-col items-center gap-12 bg-black">
            ...
            <div className="flex gap-8">
                <a href="https://x.com" target="_blank" rel="noopener noreferrer" className="w-12 h-12 border-2 border-white rounded-full flex items-center justify-center hover:bg-white hover:text-black transition-all">
                    {/* X Icon */}
